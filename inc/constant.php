...
define('SUPERUSERPASSWORD', 'superuserpassword');
define('PREKEY4PASSWORD', 'preKeyforPassword');

define('SESSIONUSER', 'sessionuser');

//cache
define('ENABLEFILECACHE', 'enablefilecache');
define('FILECACHESECS', 'filecachesecs');
...
//--exceptions--{{
//define('EMSG_NOKEYWORD', 'e_nokeyword');
//define('EMSG_NOACTION', 'e_noaction');
//--exceptions--}}
